...
'Processo de gravação de dados numa BD usando OLEDB e VB2008
...
'Comando SQL para a inserção (adaptar segundo o vosso caso)
        sql_1 = "Insert into Filmes(Nfilmes, Nome, Realizacao, Genero, Classificacao) values( " + TextBox1.Text + " , '" + TextBox2.Text + "' , '" + TextBox3.Text + "' , '" + ComboBox2.Text + "', '" + ComboBox1.Text + "' )"
        'MsgBox(sql_1)
